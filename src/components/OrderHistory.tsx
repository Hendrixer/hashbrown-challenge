  ...
  const mockOrders: Order[] = [
    {
      id: 'ORD-001',
      date: '2024-01-28',
      items: ['Pancakes x2', 'Coffee', 'Hash Browns'],
      total: 24.99,
      status: 'delivered',
      restaurant: 'Sunny Side Diner'
    },
    {
      id: 'ORD-002',
      date: '2024-01-27',
      items: ['Eggs Benedict', 'Orange Juice'],
      total: 18.49,
      status: 'delivered',
    ...
    },
    {
      id: 'ORD-003',
      date: '2024-01-26',
      items: ['French Toast', 'Bacon', 'Latte'],
      total: 22.99,
      status: 'delivered',
      restaurant: 'Morning Glory Cafe'
    },
    {
      id: 'ORD-004',
      date: '2024-01-25',
      items: ['Omelette', 'Toast', 'Green Tea'],
      total: 16.99,
      status: 'cancelled',
      restaurant: 'Early Bird Kitchen'
    }
  ];

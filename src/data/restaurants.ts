...
export const portlandBreakfastRestaurants: Restaurant[] = [
  {
    ...
    description:
      'Farm-to-table breakfast featuring organic ingredients from local Oregon farms. Known for their creative twists on classic breakfast dishes.',
    ...
    menuItems: [
      {
        ...
        description:
          'Three fluffy buttermilk pancakes topped with fresh Oregon blueberries, marionberries, and maple syrup',
        price: 14.95,
      ...
      },
      {
        ...
        description:
          'House-made English muffin with smoked salmon, poached eggs, and hollandaise sauce',
        price: 16.5,
      ...
      },
      {
        ...
        description:
          'Scrambled eggs with local cheddar, avocado, bacon, and hash browns in a spinach tortilla',
        price: 12.75,
      ...
      },
      {
        ...
        description:
          'Freshly baked scones with Oregon marionberries and vanilla glaze',
        price: 5.95,
  ...
  },
  {
    ...
    description:
      'Classic American diner with generous portions and friendly service. A Portland institution since 1987.',
    ...
    menuItems: [
      {
        ...
        description:
          'Four buttermilk pancakes with bacon, sausage, and two eggs any style',
        price: 13.95,
        category: 'Pancakes & Waffles',
      },
      {
        ...
        description:
          'Country fried steak on buttermilk biscuit with poached eggs and sausage gravy',
        price: 15.25,
        category: 'Eggs & Benedicts',
      },
      {
        ...
        description:
          'Flaky pastry filled with spiced apples and cinnamon sugar',
        price: 4.75,
        category: 'Pastries & Baked Goods',
      },
      {
        ...
        description:
          'Beef patty with fried egg, bacon, cheese, and hash browns on a brioche bun',
        price: 14.5,
        category: 'Sandwiches & Wraps',
      },
      {
  ...
  },
  {
    ...
    description:
      'Mountain-inspired breakfast spot with hearty dishes and stunning views of the Cascade Range.',
    ...
    menuItems: [
      {
        ...
        name: 'Summit Waffle',
        description:
          'Belgian waffle with whipped cream, fresh berries, and maple syrup',
        price: 11.95,
        category: 'Pancakes & Waffles',
      },
      {
        ...
        description:
          'Toasted English muffin with Canadian bacon, poached eggs, and chipotle hollandaise',
        price: 14.75,
        category: 'Eggs & Benedicts',
      },
      {
        ...
        description:
          'House-made granola with yogurt, honey, and seasonal fruit',
        price: 9.25,
        category: 'Pastries & Baked Goods',
      },
      {
      ...
      },
      {
        ...
        name: 'Cascade Coffee',
        description:
          'Medium roast coffee blend with notes of chocolate and nuts',
        price: 3.75,
        category: 'Beverages',
      },
      {
  ...
  },
  {
    ...
    description:
      "Upscale breakfast café in the heart of Portland's Pearl District, featuring artisanal ingredients and innovative presentations.",
    ...
    menuItems: [
      {
        ...
        description:
          'Soft scrambled eggs with truffle oil, chives, and crème fraîche',
        price: 18.0,
        category: 'Eggs & Benedicts',
      },
      {
        ...
        description:
          'Light and fluffy ricotta pancakes with lemon zest and berry compote',
        price: 16.5,
        category: 'Pancakes & Waffles',
      },
      {
        ...
        description:
          'Multigrain toast with smashed avocado, heirloom tomatoes, and everything seasoning',
        price: 13.75,
        category: 'Sandwiches & Wraps',
      },
      {
      ...
      },
      {
        ...
        description:
          'Rotating selection of single origin coffees brewed to order',
        price: 5.5,
        category: 'Beverages',
      },
      {
        ...
        description:
          'House-cured salmon with capers, red onion, and cream cheese',
        price: 15.95,
        category: 'Sides',
      },
    ],
  },
  {
    ...
    description:
      'Cozy neighborhood spot known for their wood-fired cooking and locally sourced ingredients.',
    ...
    menuItems: [
      {
        ...
        description:
          'Three pancakes made from our 20-year-old sourdough starter',
        price: 10.95,
        category: 'Pancakes & Waffles',
      },
      {
        ...
        description:
          'Fresh biscuit with bacon, poached eggs, and country gravy',
        price: 13.25,
        category: 'Eggs & Benedicts',
      },
      {
        ...
        description:
          'Scrambled eggs, chorizo, peppers, cheese, and salsa in a flour tortilla',
        price: 11.5,
        category: 'Sandwiches & Wraps',
      },
      {
  ...
  },
  {
    ...
    description:
      'Hip breakfast joint with creative cocktails and gourmet comfort food. Popular weekend brunch destination.',
    ...
    menuItems: [
      {
        ...
        description:
          'Fried chicken breast on Belgian waffle with spicy maple syrup',
        price: 15.95,
        category: 'Pancakes & Waffles',
      },
      {
        ...
        description:
          'House-made crab cakes with poached eggs and Old Bay hollandaise',
        price: 17.5,
        category: 'Eggs & Benedicts',
      },
      {
        ...
        description:
          'Naan bread with scrambled eggs, bacon, cheese, and arugula',
        price: 12.75,
        category: 'Sandwiches & Wraps',
      },
      {
        ...
        name: 'Bloody Mary',
        description:
          'House-made bloody mary with pickled vegetables and bacon rim',
        price: 9.5,
        category: 'Beverages',
      },
      {
  ...
  },
  {
    ...
    description:
      'Artist-owned café featuring rotating local art and creative breakfast dishes inspired by global flavors.',
    ...
    menuItems: [
      ...
      },
      {
        ...
        description:
          'Vietnamese-inspired sandwich with eggs, pickled vegetables, and sriracha mayo',
        price: 10.75,
        category: 'Sandwiches & Wraps',
      },
      {
      ...
      },
      {
        ...
        name: 'Acai Bowl',
        description:
          'Acai smoothie bowl topped with granola, berries, and coconut',
        price: 11.25,
        category: 'Pastries & Baked Goods',
      },
    ],
  },
  {
    ...
    description:
      'Family-owned restaurant serving traditional American breakfast with a focus on quality and value.',
  ...
  },
  {
    ...
    description:
      'Specialty waffle house with over 20 unique waffle creations and river views from the patio.',
    ...
    menuItems: [
      ...
      },
      {
        ...
        description:
          'Waffle base with ham, poached eggs, and hollandaise sauce',
        price: 14.5,
        category: 'Eggs & Benedicts',
      },
      {
  ...
  },
  {
    ...
    name: 'Eastside Eats',
    description:
      'Modern breakfast spot featuring healthy options and locally roasted coffee in a bright, airy space.',
    ...
    menuItems: [
      ...
      },
      {
        ...
        description:
          'High-protein pancakes made with almond flour and Greek yogurt',
        price: 12.95,
        category: 'Pancakes & Waffles',
      },
      {
      ...
      },
      {
        ...
        description:
          'Daily selection of fresh pressed vegetable and fruit juices',
        price: 6.5,
        category: 'Beverages',
      },
      {
  ...
  },
  {
    ...
    description:
      'Classic breakfast diner with generous portions and old-school charm. A local favorite for over 30 years.',
  ...
  },
  {
    ...
    description:
      'Retro-themed breakfast spot with comfort food classics and nostalgic atmosphere.',
    ...
    menuItems: [
      {
        ...
        name: 'The Principal',
        description:
          'Stack of three chocolate chip pancakes with whipped butter',
        price: 11.25,
        category: 'Pancakes & Waffles',
      },
      {
        ...
        description:
          'English muffin with ham, poached eggs, and sriracha hollandaise',
        price: 13.95,
        category: 'Eggs & Benedicts',
      },
      {
  ...
  },
  {
    ...
    description:
      'Historic breakfast house specializing in traditional pancakes and syrup made from Oregon maple trees.',
    ...
    menuItems: [
      ...
      },
      {
        ...
        description:
          'Biscuit with country ham, poached eggs, and sausage gravy',
        price: 14.25,
        category: 'Eggs & Benedicts',
      },
      {
  ...
  },
  {
    ...
    description:
      'Cheerful neighborhood café known for their creative egg dishes and friendly service.',
    ...
    menuItems: [
      ...
      },
      {
        ...
        description:
          'Cornbread with avocado, poached eggs, and chipotle hollandaise',
        price: 13.5,
        category: 'Eggs & Benedicts',
      },
      {
  ...
  },
  {
    ...
    description:
      'Eclectic breakfast spot in the Woodstock neighborhood featuring organic ingredients and vegetarian options.',
  ...
  },
  {
    ...
    description:
      'Modern American breakfast with Southern influences and craft cocktails in the Richmond neighborhood.',
    ...
    menuItems: [
      ...
      },
      {
        ...
        description:
          'Buttermilk biscuit with pulled pork, poached eggs, and bourbon hollandaise',
        price: 15.5,
        category: 'Eggs & Benedicts',
      },
      {
      ...
      },
      {
        ...
        name: 'Mint Julep',
        description:
          'Non-alcoholic mint julep with fresh mint and simple syrup',
        price: 5.75,
        category: 'Beverages',
      },
      {
  ...
  },
  {
    ...
    description:
      'Soul food breakfast spot on Mississippi Avenue serving authentic Southern comfort food.',
    ...
    menuItems: [
      {
        ...
        name: 'Soul Stack',
        description:
          'Sweet potato pancakes with cinnamon butter and maple syrup',
        price: 11.5,
        category: 'Pancakes & Waffles',
      },
      {
  ...
  },
  {
    ...
    description:
      '24-hour diner serving classic American breakfast around the clock near the Lloyd Center.',
  ...
  },
  {
    ...
    description:
      'Craft beer-focused breakfast spot with unique beer-infused dishes and local brews.',
    ...
    menuItems: [
      {
        ...
        description:
          'Pancakes made with local IPA batter and hop-infused syrup',
        price: 13.25,
        category: 'Pancakes & Waffles',
      },
      {
        ...
        name: 'Stout Benedict',
        description:
          'English muffin with bacon, poached eggs, and stout hollandaise',
        price: 14.75,
        category: 'Eggs & Benedicts',
      },
      {
      ...
      },
      {
        ...
        description:
          'Cold brew coffee with vanilla ice cream and chocolate stout',
        price: 6.95,
        category: 'Beverages',
      },
      {
  ...
  },
  {
    ...
    description:
      'Healthy breakfast café near Mt. Tabor Park featuring organic ingredients and vegetarian options.',
    ...
    menuItems: [
      ...
      },
      {
        ...
        description:
          'Multigrain toast with almond butter, banana, and chia seeds',
        price: 9.5,
        category: 'Sandwiches & Wraps',
      },
      {
  ...
  },
  {
    ...
    description:
      'Elegant breakfast spot in historic Irvington neighborhood featuring classic dishes with modern presentation.',
  ...
  },
  {
    ...
    name: 'Kenton Kitchen',
    description:
      'Neighborhood favorite in North Portland serving hearty breakfast portions at great prices.',
  ...
  },
  {
    ...
    description:
      'Cozy café in the Alameda neighborhood with homestyle cooking and friendly atmosphere.',
  ...
  },
  {
    ...
    description:
      'Family-friendly pancake house in the Piedmont neighborhood specializing in creative pancake varieties.',
  ...
  },
  {
    ...
    description:
      'Trendy breakfast spot on Foster Road known for their specialty coffee and artisan pastries.',
    ...
    menuItems: [
      {
        ...
        description:
          'Buttermilk pancakes infused with lavender and local honey',
        price: 13.75,
        category: 'Pancakes & Waffles',
      },
      {
        ...
        description:
          'Everything bagel with smoked trout, poached eggs, and dill hollandaise',
        price: 15.95,
        category: 'Eggs & Benedicts',
      },
      {
      ...
      },
      {
        ...
        name: 'Cortado',
        description:
          'Spanish-style coffee with equal parts espresso and warm milk',
        price: 4.75,
        category: 'Beverages',
      },
      {
  ...
  },
  {
    ...
    description:
      'Asian-fusion breakfast spot in the Jade District featuring unique East-meets-West breakfast dishes.',
    ...
    menuItems: [
      ...
      },
      {
        ...
        description:
          'English muffin with bulgogi, poached eggs, and gochujang hollandaise',
        price: 14.5,
        category: 'Eggs & Benedicts',
      },
      {
  ...
  },
  {
    ...
    description:
      'Upscale breakfast restaurant near Laurelhurst Park with lake views and sophisticated cuisine.',
    ...
    menuItems: [
      {
        ...
        description:
          'Thick-cut brioche with vanilla bean custard and berry compote',
        price: 16.95,
        category: 'Pancakes & Waffles',
      },
      {
        ...
        description:
          'English muffin with fresh crab, poached eggs, and tarragon hollandaise',
        price: 19.5,
        category: 'Eggs & Benedicts',
      },
      {
  ...
  },
  {
    ...
    description:
      'Community café in St. Johns neighborhood with views of the iconic suspension bridge.',
    ...
    menuItems: [
      ...
      },
      {
        ...
        description:
          'English muffin suspended with bacon, eggs, and hollandaise',
        price: 13.25,
        category: 'Eggs & Benedicts',
      },
      {
  ...
  },
  {
    ...
    description:
      'Farm-to-table breakfast spot in Montavilla featuring ingredients from local farmers markets.',
    ...
    menuItems: [
      {
        ...
        description:
          'Seasonal fruit pancakes with ingredients from local farmers',
        price: 13.5,
        category: 'Pancakes & Waffles',
      },
      {
  ...
  },
  {
    ...
    name: 'Creston Corner',
    description:
      'Neighborhood corner café in Creston-Kenilworth with homestyle breakfast and strong community ties.',
  ...
  },
  {
    ...
    description:
      'Breakfast spot in the Overlook neighborhood with panoramic views of the city and mountains.',
  ...
  },
  {
    ...
    description:
      'Historic neighborhood breakfast house serving comfort food in the heart of Boise-Eliot.',
  ...
  },
  {
    ...
    description:
      'Charming breakfast café in historic Sellwood with antique décor and homestyle cooking.',
  ...
  },
  {
    ...
    description:
      'Specialty waffle house in the Woodlawn neighborhood with creative sweet and savory options.',
  ...
  },
  {
    ...
    description:
      'Community-focused breakfast spot in Lents neighborhood supporting local producers and farmers.',
  ...
  },
  {
    ...
    description:
      'European-inspired breakfast bistro in the Beaumont-Wilshire neighborhood with French influences.',
    ...
    menuItems: [
      {
        ...
        description:
          'Brioche French toast with Grand Marnier and berry compote',
        price: 15.5,
        category: 'Pancakes & Waffles',
      },
      {
  ...
  },
  {
    ...
    description:
      'Rustic breakfast spot in Roseway neighborhood with outdoor seating and natural ambiance.',
  ...
  },
  {
    ...
    description:
      "Diverse breakfast café in the Cully neighborhood celebrating the area's multicultural community.",
  ...
  },
  {
    ...
    description:
      'Trendy breakfast spot in Concordia neighborhood popular with young professionals and families.',
  ...
  },
  {
    ...
    description:
      'Family-friendly breakfast spot near Peninsula Park with a playground view and kid-friendly menu.',
  ...
  },
  {
    ...
    description:
      'Cozy breakfast nook in Arbor Lodge with garden seating and fresh herb ingredients.',
  ...
  },
  {
    ...
    description:
      'Upscale breakfast bistro near Lloyd Center with sophisticated menu and elegant atmosphere.',
  ...
  },
  {
    ...
    description:
      'Family-owned breakfast restaurant in Humboldt neighborhood with three generations of recipes.',
  ...
  },
  {
    ...
    description:
      'Scenic breakfast spot along the Willamette River with outdoor deck and water views.',
  ...
  },
  {
    ...
    description:
      'Intimate breakfast nook in the Brooklyn neighborhood with vintage décor and comfort food.',
  ...
  },
  {
    ...
    description:
      'Bright and airy breakfast café in the Sabin neighborhood with health-conscious options.',
  ...
  },
  {
    ...
    description:
      'Historic breakfast establishment in a restored Victorian home with period-appropriate menu.',
  ...
  },
  {
    ...
    description:
      'Community-centered breakfast spot in Kerns with locally sourced ingredients and neighbor-friendly prices.',
  ...
  },
  {
    ...
    description:
      'Breakfast destination in the Buckman neighborhood with a wide variety of options for every taste.',
    ...
    menuItems: [
      {
        ...
        description:
          "Variety of pancakes representing the boulevard's diversity",
        price: 14.95,
        category: 'Pancakes & Waffles',
      },
      {
  ...
  },
  {
    ...
    description:
      'The crown jewel of Portland breakfast spots, located in Crown Heights with award-winning dishes and spectacular city views.',
